...
# output
write_tsv(punctate_upstream %>% 
            left_join(., grch38 %>% select(ensgene, symbol, description), by = c("Gene_Name" = "symbol")) %>% 
            left_join(grch38_tx2gene) %>% 
            pull(enstxp) %>% 
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_1.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_2.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_3.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_4.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_5.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_6.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_7.txt')
...
write_tsv(punctate_upstream %>% 
            ...
            unique() %>% 
            writeLines(), 
          path = '/data/mcgaugheyd/projects/nei/hufnagel/iPSC_RPE_ATAC_Seq/punctate/punctate_analysis_8.txt')
