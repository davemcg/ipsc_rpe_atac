...
## First up: More open in TSS, higher gene expression (2X or more GFP/iPSC)
...
## Second up: More open in TSS, less gene expression (-2X or more GFP/iPSC)
...
## More peaks, more expression RFP -> GFP (0.5 log2(TPM) GFP - RFP)
